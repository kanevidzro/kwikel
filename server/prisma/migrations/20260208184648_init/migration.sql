...
-- CreateIndex
CREATE INDEX "VerificationToken_token_userId_idx" ON "VerificationToken"("token", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "PasswordResetToken_token_key" ON "PasswordResetToken"("token");

-- CreateIndex
CREATE INDEX "PasswordResetToken_token_userId_idx" ON "PasswordResetToken"("token", "userId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Template_projectId_name_key" ON "Template"("projectId", "name");

-- CreateIndex
CREATE INDEX "PhoneBook_projectId_idx" ON "PhoneBook"("projectId");

-- CreateIndex
CREATE UNIQUE INDEX "PhoneBook_projectId_name_key" ON "PhoneBook"("projectId", "name");

-- CreateIndex
CREATE INDEX "Contact_phoneBookId_idx" ON "Contact"("phoneBookId");

-- CreateIndex
CREATE INDEX "Contact_phone_idx" ON "Contact"("phone");

-- CreateIndex
CREATE UNIQUE INDEX "Contact_phoneBookId_phone_key" ON "Contact"("phoneBookId", "phone");
...
-- AddForeignKey
ALTER TABLE "SmsMessage" ADD CONSTRAINT "SmsMessage_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES "Template"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PhoneBook" ADD CONSTRAINT "PhoneBook_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Contact" ADD CONSTRAINT "Contact_phoneBookId_fkey" FOREIGN KEY ("phoneBookId") REFERENCES "PhoneBook"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Campaign" ADD CONSTRAINT "Campaign_phoneBookId_fkey" FOREIGN KEY ("phoneBookId") REFERENCES "PhoneBook"("id") ON DELETE SET NULL ON UPDATE CASCADE;
