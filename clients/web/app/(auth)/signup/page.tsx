...
export const metadata: Metadata = {
  title: "Sign Up | Dugble",
  description:
    "Sign up to start sending SMS, OTPs, and emails reliably across Africa.",
  robots: { index: false, follow: true },
  alternates: { canonical: "https://dugble.com/signup" },
  openGraph: {
    siteName: "Dugble",
    type: "website",
    url: "https://dugble.com/signup",
