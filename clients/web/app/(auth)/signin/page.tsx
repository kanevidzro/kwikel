...
export const metadata: Metadata = {
  title: "Sign In | Dugble",
  description:
    "Sign in to your Dugble account to manage SMS, OTP, and Email APIs.",
  robots: { index: false, follow: true },
  alternates: { canonical: "https://dugble.com/signin" },
  openGraph: {
    siteName: "Dugble",
    type: "website",
    url: "https://dugble.com/signin",
